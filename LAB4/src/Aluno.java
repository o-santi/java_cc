...
//    protected float cra;  // "public" dentro do mesmo package + subclasses
    ...
    public Aluno() {
        this(0, "Sem Nome", -1);  // chamando a sobrecarga de construtor deste objeto
    }

    public Aluno(long dre, String nome) {
	this(dre, nome, -1) // chamando a sobrecarga sem o ano de nascimento
    }

    public Aluno(long dre, String nome, int anoNascimento) {
...
//    }
    ...
    public String toString() {  // override (assinatura idêntica)
        return String.format("%s (DRE: %d) (%d)", nome, dre, getAnoNascimento());
    }
